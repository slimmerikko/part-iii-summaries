...
%		We have 
%		\begin{gather*}
%			\phi_{\sigma\sigma'/(\sigma^2 + \sigma'^2)^{1/2}}(x - \mu^*) \phi_{(\sigma + \sigma')^{1/2}}(\mu - \mu') \\
%			= \frac{1}{2\pi \sigma \sigma'} \exp(-\frac12\qty(\frac{(x - \mu^*)^2(\sigma^2 + \sigma'^2)}{\sigma^2 \sigma'^2} + \frac{(\mu - \mu^*)^2}{\sigma^2 + \sigma'^2})) \\
%			= \frac{1}{2\pi \sigma \sigma'} \exp\qty(-\frac12\qty(\frac{(x - \mu^*)^2(\sigma^2 + \sigma'^2)^2 + \sigma^2 \sigma'^2 (\mu - \mu^*)^2}{\sigma^2 \sigma'^2(\sigma^2 + \sigma'^2)})) \\
%			=  \frac{1}{2\pi \sigma \sigma'}\exp\qty(-\frac12\qty(\frac{
%			x^2(\sigma^2 + \sigma'^2)^2 + (\sigma'^2\mu + \sigma^2\mu')^2 - 2x (\sigma'^2\mu + \sigma^2\mu') (\sigma^2 + \sigma'^2)	
